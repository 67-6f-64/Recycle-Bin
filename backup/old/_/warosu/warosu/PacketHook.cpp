...
namespace PH{
	DWORD SendHook_Addr = 0x0180D5EC;
	DWORD SendHook_ret = 0x017EB9DF;
	DWORD RecvHook_ret = 0x0057E6C1;
	DWORD RecvHook_Pointer = 0x01295094;
...
BOOL PH::PacketHook(){
	...
	//hello
	Asm::Write_code(0x017E81F6, "31 C0 31 C9 90");
	Asm::Write_code(0x0186D139, "31 C0 31 C9 90");
	Asm::Write_code(0x01B7345F, "31 C0 31 C9 90");
	//world
