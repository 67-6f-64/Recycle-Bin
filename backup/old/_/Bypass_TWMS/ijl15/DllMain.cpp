...
void DisableSecurity(){
	DWORD ASPLunchr = Air::AobScan("55 8B EC 83 EC 0C 56 57 6A 00 8B F1 E9");
	DWORD mkd25tray = Air::AobScan("55 8B EC 83 EC 0C 56 57 6A 00 8B F1 E9", 2);
	DWORD Autoup = Air::AobScan("56 8D 71 2C 8B CE E8");

	Air::WriteCode(ASPLunchr, "31 C0 C3");
	Air::WriteCode(mkd25tray, "31 C0 C3");
	Air::WriteCode(Autoup , "31 C0 C3");
}
