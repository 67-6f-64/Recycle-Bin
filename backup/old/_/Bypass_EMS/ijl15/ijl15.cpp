...
void _declspec(naked, dllexport) ijlInit(){_asm{jmp dword ptr [dwExport1]}}
void _declspec(naked, dllexport) ijlFree(){_asm{jmp dword ptr [dwExport2]}}
void _declspec(naked, dllexport) ijlRead(){_asm{jmp dword ptr [dwExport3]}}
void _declspec(naked, dllexport) ijlWrite(){_asm{jmp dword ptr [dwExport4]}}
void _declspec(naked, dllexport) ijlGetLibVersion(){_asm{jmp dword ptr [dwExport5]}}
void _declspec(naked, dllexport) ijlErrorStr(){_asm{jmp dword ptr [dwExport6]}}
