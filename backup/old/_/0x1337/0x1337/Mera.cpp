...
void EditControlAddString(HWND hwnd, int nIDDlgItem, char *NewValue, bool NL){
	int Elength = SendDlgItemMessageA(hwnd, nIDDlgItem, WM_GETTEXTLENGTH, NULL, NULL);

	if(NL){//NewLine
		SendDlgItemMessageA(hwnd, nIDDlgItem, EM_SETSEL, Elength, Elength);
		SendDlgItemMessageA(hwnd, nIDDlgItem, EM_REPLACESEL, NULL, (LPARAM)"\r\n");
		Elength = SendDlgItemMessageA(hwnd, nIDDlgItem, WM_GETTEXTLENGTH, NULL, NULL);
	}

	SendDlgItemMessageA(hwnd, nIDDlgItem, EM_SETSEL, Elength, Elength);
	SendDlgItemMessageA(hwnd, nIDDlgItem, EM_REPLACESEL, NULL, (LPARAM)NewValue);
}