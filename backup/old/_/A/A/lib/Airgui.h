...
namespace Airgui{
		...
		HWND SetButton(HWND hwnd, int INDEX, char Caption[], int x, int y, int nWidth, int nHeight, int fsize = 12, char fname[] = "‚l‚r ƒSƒVƒbƒN");
		HWND SetCheck(HWND hwnd, int INDEX, char Caption[], int x, int y, int nWidth, int nHeight, int fsize = 12, char fname[] = "‚l‚r ƒSƒVƒbƒN");
		HWND SetStatic(HWND hwnd, int INDEX, char Caption[], int x, int y, int nWidth, int nHeight, int fsize = 12, char fname[] = "‚l‚r ƒSƒVƒbƒN");
		HWND SetEdit(HWND hwnd, int INDEX, char Caption[], int x, int y, int nWidth, int nHeight, int fsize = 12, char fname[] = "‚l‚r ƒSƒVƒbƒN");
