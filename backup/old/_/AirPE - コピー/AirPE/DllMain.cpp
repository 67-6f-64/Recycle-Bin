...
DWORD dwSendHookAddr = 0x01F01DCE;
DWORD dwSendHookRet = 0x01FEE74E;
...
DWORD dwRecvHookPointer = 0x0172222C;
DWORD dwRecvHookRet = 0x005D5431;
...
void _stdcall SendPacket(){
	...
	char *NextPacket = AW.GetString(EditInject);
	...
	AW.SetString(EditInject, NextPacket);
}
