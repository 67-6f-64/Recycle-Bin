...
class AirWindow{
	private:
		...
		void _stdcall _SetFormatString(int nIDDlgItem, char *_Format, DWORD *dwArgument);
	...
	public:
		...
		void _stdcall SetFormatString(int nIDDlgItem, char *_Format, ...);
