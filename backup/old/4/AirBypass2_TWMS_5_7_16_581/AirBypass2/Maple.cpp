...
void Bypass(){
	...
	ASPLunchr = AM.AobScan("55 8B EC 83 EC 0C 56 57 6A 00 8B F1 E9");
	mkd25tray = AM.AobScan("55 8B EC 83 EC 0C 56 57 6A 00 8B F1 E9", 2);
	...
	*/
	...
	MSCRC23 = AM.AobScan("55 8B EC 6A FF 68 ?? ?? ?? ?? 64 A1 00 00 00 00 50 81 EC ?? ?? ?? ?? 53 56 57 A1 ?? ?? ?? ?? 33 C5 50 8D ?? ?? 64 A3 00 00 00 00 89 8D ?? ?? ?? ?? 83 A5 ?? ?? ?? ?? 00 6A 01");
	if(MSCRC23){
